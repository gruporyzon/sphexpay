...
const titles:Record<string,string>={sale_approved:'Venda aprovada!',pix_generated:'Pix gerado!',credit_card_approved:'Pagamento cartão de crédito aprovado!',boleto_generated:'Boleto gerado!',subscription_approved:'Assinatura aprovada!',subscription_renewed:'Assinatura renovada!',refund_done:'Reembolso realizado!',chargeback_received:'Chargeback recebido!',withdrawal_sent:'Saque enviado!',sale_pending:'Nova venda pendente!',payment_refused:'Pagamento recusado!'}
