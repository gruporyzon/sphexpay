...
Deno.serve(async request=>{
 ...
 if(!url||!anon||!serviceRole||!publicKey||!privateKey||!subject)return Response.json({success:false,code:'PUSH_SERVER_NOT_CONFIGURED',message:'Servidor de notificações indisponível.'},{status:503})
