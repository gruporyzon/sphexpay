...
export const notificationRoutes:Record<CommerceNotificationType,string>={
 sale_approved:'/app/vendas',sale_pending:'/app/vendas',pix_generated:'/app/vendas',pix_approved:'/app/vendas',pix_paid:'/app/vendas',credit_card_approved:'/app/vendas',credit_card_refused:'/app/vendas',boleto_generated:'/app/vendas',boleto_paid:'/app/vendas',subscription_approved:'/app/assinaturas',subscription_renewed:'/app/assinaturas',refund_done:'/app/vendas',chargeback_received:'/app/vendas',withdrawal_requested:'/app/financeiro/saques',withdrawal_sent:'/app/financeiro/saques',withdrawal_completed:'/app/financeiro/saques',payment_refused:'/app/vendas'
}
