...
export function useNotificationGenerator(){
 ...
 const tick=useCallback(async()=>{
  ...
  if(!ok){finish('failed',deliveryError.current||'PUSH_DELIVERY_FAILED: não foi possível enviar a notificação ao dispositivo.');return}
