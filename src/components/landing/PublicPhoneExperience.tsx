import { BarChart3,Bell,Check,CreditCard,LockKeyhole,Radio,ShieldCheck,TrendingUp,WalletCards,Zap } from 'lucide-react'
...
export function PublicPhoneExperience(){
 return <div className="public-phone-stage" aria-label="Interface ilustrativa do aplicativo SphexPay com eventos da operação">
  ...
  <article className="phone-float phone-float-conversion"><i><TrendingUp/></i><span><small>Conversão</small><b>94,7%</b></span></article>
  <div className="public-phone">
   <div className="public-phone-frame">
    ...
    <main>
     ...
     <section className="phone-stats"><article><WalletCards/><span>Faturamento</span><b>R$ 24,8 mil</b></article><article><BarChart3/><span>Ticket médio</span><b>R$ 345,28</b></article></section>
  ...
  <div className="phone-payment-chip" aria-label="Meios de pagamento ilustrados"><Zap/> Pix <CreditCard/> Cartão</div>
 </div>
}
