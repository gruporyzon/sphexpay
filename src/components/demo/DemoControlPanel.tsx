   ...
   <div className="demo-config-scroll">
    ...
    <details open><summary>Notificações da operação</summary><div className="mode-push-settings">
     ...
     <div className="demo-config-grid">
      <Field label="Enviar para"><select value={draft.pushNotifications.destination} onChange={event=>setPush('destination',event.target.value as DemoConfig['pushNotifications']['destination'])}><option value="current">Este dispositivo</option><option value="all">Todos os dispositivos</option><option value="desktop">Computadores</option><option value="mobile">Celulares</option><option value="selected">Dispositivos selecionados</option></select></Field>
