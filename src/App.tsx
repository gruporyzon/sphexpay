...
import { StripeConnectRedirect } from './components/finance/StripeConnectCard'
...
const StripePaymentPage=lazy(()=>import('./features/products/StripePaymentPage'))
...
const modules=[['competicao',<CompetitionPage/>],['vendas-ao-vivo',<Suspense fallback={<Loading/>}><LiveSalesWorld/></Suspense>],['vendas',<LiveSales/>],['vendas/:transactionId',<LiveSales/>],['transacoes/*',<NavigateTransactionsAlias/>],['produtos',<ProductsHub><Deferred><ProductsV2Page/></Deferred></ProductsHub>],['produtos/checkout',<ProductsHub><CheckoutPage/></ProductsHub>],['produtos/checkout/:checkoutId',<ProductsHub><CheckoutPage/></ProductsHub>],['produtos/links',<ProductsHub><LinksPage/></ProductsHub>],['produtos/links/:linkId',<ProductsHub><LinksPage/></ProductsHub>],['checkout/*',<NavigateOperationsAlias destination="checkout"/>],['links/*',<NavigateOperationsAlias destination="links"/>],['links-de-pagamento/*',<NavigateOperationsAlias destination="links"/>],['vitrine',<Showcase/>],['assinaturas',<Deferred><SubscriptionsPage/></Deferred>],['integracoes',<Integrations/>],['verificacao',<Deferred><KycPage/></Deferred>],['afiliados',<Deferred><AffiliatesPage/></Deferred>],['premiacoes',<DemoAwareAwards/>],['relatorios',<ReportsModule/>],['relatorios/clientes',<ReportsModule/>],['clientes/*',<Navigate to="/app/relatorios/clientes" replace/>],['notificacoes',<NotificationsPage/>],['configuracoes',<Settings/>]] as const
