...
export default function WithdrawalsSection(){
 ...
 return <section className="withdrawals-secure" aria-label="Saques"><header className="financial-section-heading"><h2>Saques</h2><p>Solicite saques e acompanhe o histórico de movimentações.</p></header>
