 ...
 return <div className="landing landing-v2" id="top">
  ...
  <main id="public-content">
   ...
   <section className="landing-hero" aria-labelledby="landing-title"><div className="hero-grid"/><div className="hero-orb orb-one"/><div className="hero-orb orb-two"/>
    <div className="landing-hero-copy"><span className="landing-kicker"><i/> Infraestrutura financeira para negócios digitais</span><h1 id="landing-title">Sua operação no ritmo do seu <em>próximo nível.</em></h1><p>Venda, acompanhe e evolua com uma plataforma que transforma pagamentos, clientes e resultados em uma visão clara para decidir melhor.</p><div className="landing-hero-actions"><Link className="public-primary" to={accountDestination}>{user?'Acessar meu painel':'Criar minha conta'} <ArrowRight/></Link><a href="#plataforma">Conhecer a plataforma</a></div><ul className="hero-assurances" aria-label="Diferenciais de acesso"><li><Check/> Ativação orientada</li><li><Check/> Segurança avançada</li><li><Check/> Operação em tempo real</li></ul>
